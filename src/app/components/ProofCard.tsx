...
export function ProofCard({ mediaLabel, mediaType, diagram, headline, metrics, artifacts, index, onCta }: {
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video bg-[var(--saas-inner-bg)] border-b border-[var(--saas-border)] p-4">
        ...
        <div className="w-full h-full flex items-center justify-center pt-3">{diagram}</div>
      </div>
