  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[rgba(200,241,53,0.1)] border border-[rgba(200,241,53,0.25)] flex items-center justify-center text-[var(--saas-lime)] font-syne font-extrabold text-lg sm:text-xl shrink-0">
          {initials}
        </div>
        <div>
